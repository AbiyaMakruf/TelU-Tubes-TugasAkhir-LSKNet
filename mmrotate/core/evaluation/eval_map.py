...
def eval_rbbox_map(det_results,
    ...
    # Start Tambahan
    # Debugging det_results
    # logging.basicConfig(filename='det_results_debug.log', level=logging.INFO)
    # logging.info(f"det_results length: {len(det_results)}")
    # for i, det in enumerate(det_results):
    #     if not det:
    #         logging.info(f"Image {i} has no detections!")
    #     else:
    #         logging.info(f"Image {i} detections: {det}")
    # End Tambahan
